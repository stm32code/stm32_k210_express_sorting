...
#endif
// 设备信息
#define PROID "smartdevice&h9sjEGr1om8"															 // 产品ID
#define DEVID "h9sjEGr1om8.smartdevice|securemode=2,signmethod=hmacsha256,timestamp=1714301135931|" // 设备ID
#define AUTH_INFO "507f0bd74dfe9639e4d1a70e3e5a1d6ed447314ccc3d1516d3064afdbbf233d5"						 // 鉴权信息
// MQTT主题 /broadcast/
#define S_TOPIC_NAME "/broadcast/h9sjEGr1om8/test1" // 需要订阅的主题
#define P_TOPIC_NAME "/broadcast/h9sjEGr1om8/test2" // 需要发布的主题

#define P_TOPIC_CMD "/sys/h9sjEGr1om8/user-device/thing/event/property/post"
